...
<div class="baiduorder-index">
  <div class="accounts">
  <!--  <ul>
      <li>本月收入：￥<strong><?=$monthIncome?></strong>元</li>
  ...
  <div class="accounts">
    <ul>
      ...
      <li>今日完成：<strong><?=$incount?></strong>个</li>
      <li>昨日完成：<strong><?=$yesterdayincount?></strong>个</li>
      <li>当月完成：<strong><?=$monthincount?></strong>个</li>
      <!--<li>昨日获得积分：<strong>0</strong></li>
      <li>当月获得积分：<strong>0</strong></li>-->
      <li>当日收入：<strong><?=$allDayIncome?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome?></strong></li>
    </ul>
  </div>
  ...
  <div class="accounts">
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(2)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome2?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome2?></strong></li>
    </ul>
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(3)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome3?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome3?></strong></li>
    </ul>
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(4)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome4?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome4?></strong></li>
    </ul>
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(5)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome5?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome5?></strong></li>
    </ul>
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(7)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome7?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome7?></strong></li>
    </ul>
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(6)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome6?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome6?></strong></li>
    </ul>
    ...
    <ul>
      ...
      <li>当日收入：<strong><?=Account::allDayIncome(9)?></strong></li>
      <li>昨日收入：<strong><?=$allYesterdayIncome8?></strong></li>
      <li>当月收入：<strong><?=$allMonthIncome8?></strong></li>
    </ul>
  </div>
