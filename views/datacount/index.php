...
<table>
    <tr>
      ...
      <td>当日：<strong><?=DatacountController::DataCount('baiduorder')['day'];?>/3800</strong></td>
      <td>昨日：<strong><?=DatacountController::DataCount('baiduorder')['yesterday'];?>/3800</strong></td>
      
    </tr>
    <tr>
      <td class="title"><strong>流量赚</strong></td>
      <td>当日：<strong><?=DatacountController::DataCount('baiduorder_llz')['day'];?>/3800</strong></td>
      <td>昨日：<strong><?=DatacountController::DataCount('baiduorder_llz')['yesterday'];?>/3800</strong></td>
